 ...
 * BugFix
 * Descriptions:
 * 1. Renamed class file and name from Dijkstra to DijkstraGraphExample
 * 2. Added package name
 * 3. Optimized imports
 */
public class DijkstraGraphExample {
    ...
    private static void dijkstra(DijkstraGraph g, int src) {
        int V = g.v;
        int dist[] = new int[V];
