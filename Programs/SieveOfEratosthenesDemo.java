package Programs;// Program to find all the primes upto N using Sieve Of Eratosthenes technique.
 ...
 * BugFix
 * Descriptions:
 * 1. Renamed class file and name from Sieve_Of_Eratosthenes to SieveOfEratosthenesDemo
...
public class SieveOfEratosthenesDemo {
    public static void main(String args[]) {
        ...
        SieveOfEratosthenesDemo nm = new SieveOfEratosthenesDemo();
        int n = sc.nextInt();
